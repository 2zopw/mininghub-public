...
namespace MiningHub.Core.Blockchain.Ethereum
{
    public class EthereumConstants
    {
        ...
        public static double ScoreFactor = 20000000000000;
        public static BigInteger BigMaxValue = BigInteger.Pow(2, 256);
        public static BigInteger BigPow2x256 = BigInteger.Pow(2, 256);
        public static ulong StratumDiffFactor = 10000000000;
        public static double NicehashStratumDiffFactor = 2.328295;
